...
class ChooseStoryPage extends React.Component {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonsPanel}>
          <View style={styles.halfPanel}>
            <TouchableOpacity style={styles.btn} onPress={() => this.props.dispatch(joinStory())}>
                <Text style={{'color': '#F9A602'}}>JOIN!</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.halfPanel}>
            <TouchableOpacity style={styles.btn} onPress={() => this.props.dispatch(skipStory())}>
